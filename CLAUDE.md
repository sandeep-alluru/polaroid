# scenemem — Session Anchor

**Research spec:** `../tech-research/12-Embodied-and-Physical-World/scenemem-a-persistent-shared-spatial-semantic-memory-la/README.md`  
...
- NL query interface: `scenemem.query("what's near the door?")`
